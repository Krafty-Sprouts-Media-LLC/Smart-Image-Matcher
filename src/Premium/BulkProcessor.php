		...
		wp_localize_script(
			...
			array(
				...
				'i18n'                  => array(
					...
					'confirmNeverUse'   => __( 'Block %s from featured-image auto-assign? Other heading review slots keep this file. Existing featured assignments are flagged by Fix Incorrect Featured Images.', 'smart-image-matcher' ),
				),
			)
		);
	}
