		...
		<section id="sim-fal-recovery" class="sim-recovery-panel" aria-labelledby="sim-fal-recovery-title">
			<div class="sim-section-head">
				<div>
					...
					<p class="description">
						<?php esc_html_e( 'Find images that completed on fal.ai but never reached WordPress. Matches use the post title and SEO focus/target keyword against the fal prompt — only posts still missing a featured image, limited to the Post Status checkboxes above (Publish recommended). Preview first, then recover confirmed matches in the background.', 'smart-image-matcher' ); ?>
					</p>
				</div>
			</div>
